...
delete "Aphelions.Frontier_Overhaul\scripts\vscripts\ui\menu_map_select.nut" and "Aphelions.Frontier_Overhaul\scripts\vscripts\menu\_lobby.nut".

This mod is offline, so server browsing is disabled.
