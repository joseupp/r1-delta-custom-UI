...
// const LOBBY_BACKGROUND_MOUNTAINS = "../ui/menu/common/menu_background_mountains"
// const LOBBY_BACKGROUND_DEMETER = "../ui/menu/common/menu_background_demeter"
...
{
    if ( !IsDelta() )
        return ::AmIPartyLeader__()

    if ( level.ui.isDedicatedServer )
        return false

    local privateMatchLeaderNameHash = level.ui.listenHostUsernameHash

    if ( privateMatchLeaderNameHash == null )
        return false
